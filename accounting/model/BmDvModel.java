...
public class BmDvModel {
	
	public int dv_code;
	public String bacc_code;
	public String dacc_code;
	public String loginID;
	public String name;
	public String biz_code;
	public String dv_date;
	public String dv_udate;
	public int dv_fee;
	public String dv_memo;
	public String dv_sign;
	public String dv_reres;
	public int file_code;
	public String file_name;
	
	public String bacc_name; //계정과목명
	public String dacc_name; //계정과목소명
	public String biz_name; //거래처명
	public String detail_name; //승인여부
	public String signID; //승인자아이디
