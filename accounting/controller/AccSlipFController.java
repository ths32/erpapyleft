...
public class AccSlipFController {
	...
	@RequestMapping("accSlipFVue.do")
	public String accSlipFVue(Model model, @RequestParam Map<String, Object> paramMap) throws Exception {
		logger.info("+ Start " + className + ".accSlipF");
		logger.info("   - paramMap : " + paramMap);
		
		logger.info("+ End " + className + ".accSlipF");
		return "accounting/accslipfVue";
	}	
	
	// --------------------------------------------------------------------------------------------------------------------
	@RequestMapping("accslipflistVue.do")
	@ResponseBody
	public Map<String,Object> accslipflistVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		
		logger.info("+ Start " + className + ".accslipflistVue");
		logger.info("   - paramMap : " + paramMap);
		...
		returnmap.put("accslipflist",accslipflist);
		returnmap.put("countaccslipflist", countaccslipflist);
		returnmap.put("pageSize", pageSize);
		returnmap.put("cpage", cpage);
		
		logger.info("+ End " + className + ".accslipflistVue");
	...
	public String accslipfmodal(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
		...
		//List<AccSlipFModel> accslipfmodal = accslipfService.accslipflist(paramMap);
	...
	@RequestMapping("accslipfmodalVue.do")
	@ResponseBody
	public Map<String, Object> accslipfmodalVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		
		logger.info("+ Start " + className + ".accslipfmodalVue");
		logger.info("   - paramMap : " + paramMap);
		...
		result.put("countaccslipflist", countaccslipflist);
		result.put("accslipfmodal",accslipfmodal);
		
		
		logger.info("+ End " + className + ".accslipfmodalVue");
		return result;
	}
	// =================================================================
